            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>Use high-quality JPG, SVG, PNG or GIF less than 20MB</p>
                </div>
                <input
                  type='file'
                  name='upload-image'
              ...
              <div className='relative h-full'>
                ...
                <button
                  type='button'
                  className='absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl cursor-pointyer outline-none hover:shadow-md transition-all duration-500 ease-in-out'
